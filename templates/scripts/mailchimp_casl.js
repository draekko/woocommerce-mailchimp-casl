...
(function($) {
    /* CHECKOUT CODE */
    $('#mailchimp_casl_opt_in_subscription').off('click').click( function(e) {
        e.stopPropagation();
        if($(this).is(":checked")) {
	...
	$('#mc_casl_cancel_checkout_thankyou_button').click(function(e) {
	...
	$('#mc_casl_cancel_checkout_error_button').click(function(e) {
            $(".mc_casl_agreement_box_checkout").css('display', 'block');
            $(".mc_casl_error_box_checkout").css('display', 'none');
            $(".mc_casl_thankyou_box_checkout").css('display', 'none');
	...
	$('#mailchimp_casl_checkout_button').click(function(e) {
	...
	$('#mc_casl_cancel_checkout_button').click(function(e) {
        e.stopPropagation();
	...
	$('input[type=button]#mc_casl_submit_button.mailchimp_casl_newsletter_button').click(function(e) {
					...
					$('input[type=submit]#mailchimp_casl_button.mailchimp_casl_newsletter_submit.agreement_fix').off('click').click( function(e) {
						...
						if ( $( '#mc_casl_agreement_check' ).is( ":checked" ) ) {
                            ...
                            var data = {
		                        ...
		                        'mc_casl_email': getEmail(),
		                        'mc_casl_dob': getDOB(),
		                        'mc_casl_bday': getBDay(),
		                        'mc_casl_fname' : getFirstName(),
		                        'mc_casl_lname' : getLastName()
	                        };
	...
	$('input[type=button].mailchimp_casl_newsletter_button.agreement_fix').click(function(e) {
		$(".mc_casl_agreement").css("display", "none");
	});
